            ...
            <div className="flex justify-between h-16">
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  ...
                  <div className="relative group">
                    <button className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700">
                      Reports
